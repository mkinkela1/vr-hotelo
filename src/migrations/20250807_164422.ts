...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "tenants" ADD CONSTRAINT "tenants_whitelabel_id_whitelabels_id_fk" FOREIGN KEY ("whitelabel_id") REFERENCES "public"."whitelabels"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "whitelabels" ADD CONSTRAINT "whitelabels_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_whitelabels_fk" FOREIGN KEY ("whitelabels_id") REFERENCES "public"."whitelabels"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "whitelabels_tenant_idx" ON "whitelabels" USING btree ("tenant_id");
  CREATE INDEX "whitelabels_updated_at_idx" ON "whitelabels" USING btree ("updated_at");
  CREATE INDEX "whitelabels_created_at_idx" ON "whitelabels" USING btree ("created_at");
  CREATE UNIQUE INDEX "whitelabels_filename_idx" ON "whitelabels" USING btree ("filename");
  ...
  CREATE INDEX "payload_locked_documents_rels_whitelabels_id_idx" ON "payload_locked_documents_rels" USING btree ("whitelabels_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "whitelabels" CASCADE;
